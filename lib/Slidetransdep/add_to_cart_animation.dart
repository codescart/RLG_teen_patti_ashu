...
class AddToCartAnimations extends StatefulWidget {
  final Widget child;
  ...
  @override
  _AddToCartAnimationsState createState() => _AddToCartAnimationsState();
}

class _AddToCartAnimationsState extends State<AddToCartAnimations> {
