...
import 'package:ultimate_teen_patti/transation/SlideShowTrans.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //       child: Text('raja',style: TextStyle(color: Colors.white),),
    // ),
    //   )
      // TestApp()
      // SlideShowTrans()
                      ...
                      child: Column(children: [
                        InkWell(
                          ...
                          child: FAProgressBar(
                            ...
                            child: Image.asset('assets/images/greenbox.png'),
